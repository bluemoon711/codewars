...
11 it is 4. Between 2 and 50 we have the following pairs of 2 - gaps primes: 3 - 5, 5 - 7, 11 - 13, 17 - 19, 29 - 31,
41 - 43
...
//function well but didn't pass due to overtime....
function gap(g, m, n) {
  var arr = calculatePrimesForRange(m, n);
  var out = [];
  ...
  return out[0] == undefined ? null : out[0];
}
